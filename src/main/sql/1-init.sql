...
ALTER TABLE public.seat_types ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.seat_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: seat_types uk_seat_types_name; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.seat_types
    ADD CONSTRAINT uk_seat_types_name UNIQUE (name);


--
-- Name: seat_types uk_seat_types_color; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.seat_types
    ADD CONSTRAINT uk_seat_types_color UNIQUE (color);
...
--
-- Name: route_prices fk_route_prices_seat_type; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.route_prices
    ADD CONSTRAINT fk_route_prices_seat_type FOREIGN KEY (seat_type_id) REFERENCES public.seat_types(id);
